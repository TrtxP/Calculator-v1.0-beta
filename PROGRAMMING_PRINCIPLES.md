...
2. Written [two the mess boolean variables](./Calculator/Form1.cs#L14-L15) that should be replaced by "return" statement in checking certain conditions as in example of [checking the input a displayed text on textBox display](./Calculator/Form1.cs#L189-L200)
3. Displaying of [nonsence messages about warnings or errors](./Calculator/Form1.cs#L197) that should be removed by "return" statement for stopping execution of programm
---
